...
@interface TideRadarObject : KrollCoverageObject {
#else
@interface TideRadarObject : KrollObject {
#endif
@private
...
extern NSString * TideRadar$ModuleRequireFormat;
