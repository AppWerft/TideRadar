...
/**
 Base class for all TideRadar views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the TideRadar view hierarchy (such as wrapped iOS UIViews) was touched.
