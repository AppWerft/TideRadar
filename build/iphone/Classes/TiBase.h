...
// in simulator we redefine to format for TideRadar Developer console
...
{\
	NSString * exceptionName = [@"org.tideradar." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.tideradar";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UITideRadarNativeItemNone = -1, 
	UITideRadarNativeItemSpinner = -2,
	UITideRadarNativeItemProgressBar = -3,
	
	UITideRadarNativeItemSlider = -4,
	UITideRadarNativeItemSwitch = -5,
	UITideRadarNativeItemMultiButton = -6,
	UITideRadarNativeItemSegmented = -7,
	
	UITideRadarNativeItemTextView = -8,
	UITideRadarNativeItemTextField = -9,
	UITideRadarNativeItemSearchBar = -10,
	
	UITideRadarNativeItemPicker = -11,
	UITideRadarNativeItemDatePicker = -12,
	
	UITideRadarNativeItemInfoLight = -13,
	UITideRadarNativeItemInfoDark = -14,
	
	UITideRadarNativeItemDisclosure = -15,
	
	UITideRadarNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all TideRadar instances of
