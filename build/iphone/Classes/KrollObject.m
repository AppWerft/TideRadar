...
//@interface TideRadarObject : NSObject
//@end

@interface TideRadarObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[TideRadarObject class]])
		{
			for (NSString *key in [[(TideRadarObject*)o modules] allKeys])
			{
